...
// Lucky elements live in ./lucky so client bundles can import just that table
// (see the note there). Re-exported for existing server-side callers.
export { LUCKY } from "./lucky";
export type { Lucky, LuckyColor } from "./lucky";
